...
#include "src/pbbox/proto/test.pb.h"
...
void protobuf_AssignDesc_src_2fpbbox_2fproto_2ftest_2eproto() {
  protobuf_AddDesc_src_2fpbbox_2fproto_2ftest_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "src/pbbox/proto/test.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_src_2fpbbox_2fproto_2ftest_2eproto);
}
...
void protobuf_AddDesc_src_2fpbbox_2fproto_2ftest_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\032src/pbbox/proto/test.proto\"\037\n\004test\022\n\n\002"
    "id\030\001 \002(\005\022\013\n\003msg\030\002 \001(\t", 61);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "src/pbbox/proto/test.proto", &protobuf_RegisterTypes);
  test::default_instance_ = new test();
  test::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_src_2fpbbox_2fproto_2ftest_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_src_2fpbbox_2fproto_2ftest_2eproto {
  StaticDescriptorInitializer_src_2fpbbox_2fproto_2ftest_2eproto() {
    protobuf_AddDesc_src_2fpbbox_2fproto_2ftest_2eproto();
  }
} static_descriptor_initializer_src_2fpbbox_2fproto_2ftest_2eproto_;
...
const test& test::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_src_2fpbbox_2fproto_2ftest_2eproto();
