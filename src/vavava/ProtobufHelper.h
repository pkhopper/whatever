...
namespace vavava
{
    ...
    struct ProtobufHelper_Config
    {
        ...
        {
            return vavava::util::RandomIteger<int32_t>(int_min, int_max);
        }
        uint32_t random_uint32()
        {
            return vavava::util::RandomIteger<uint32_t>(0, int_max);
        }
        int64_t random_int64()
        {
            return vavava::util::RandomIteger<int64_t>(int_min, int_max);
        }
        uint64_t random_uint64()
        {
            return vavava::util::RandomIteger<uint64_t>(0, int_max);
        }
        float random_float()
        {
            return vavava::util::Random::Inst().Float(float_min, float_max);
        }
        ...
        bool random_bool()
        {
            return vavava::util::RandomIteger<int>(0, 1) == 0;
        }
        ...
        {
            return vavava::util::RandomIteger<int32_t>(1, repeated_count_max);
        }
    };
